...
export default function Home() {
  return (
    <main className="relative overflow-hidden bg-[#0b0f17] text-white">
      ...
      <section className="relative px-6 py-18 sm:px-10 lg:px-14 lg:py-24">
          ...
          <div className="space-y-6">
            <div className="glass-panel rounded-[32px] p-7 sm:p-8">
              ...
              <div className="mt-5 space-y-4 text-sm leading-7 text-white/72">
                <div>
                  ...
                  <p className="mt-2 text-base text-white">Undergraduate Student in Computer Science &amp; Engineering</p>
                </div>
                <div>
                  <span className="block text-xs uppercase tracking-[0.35em] text-white/40">University</span>
                  <p className="mt-2 text-base text-white">Bangladesh University of Professionals (BUP)</p>
                </div>
                <div>
                  <span className="block text-xs uppercase tracking-[0.35em] text-white/40">Current Role</span>
                  <p className="mt-2 text-base text-white">Assistant Joint Secretary (Logistics), BUP Computer Programming Club</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel rounded-[32px] p-7 sm:p-8">
              ...
              <ul className="mt-5 space-y-3 text-sm leading-6 text-white/72">
                <li>Focused on problem solving, software development, and continuous learning.</li>
                <li>Interested in cloud computing and scalable modern systems.</li>
                <li>Enjoys football, which reinforces discipline and teamwork.</li>
              </ul>
            </div>
          </div>
        </div>
